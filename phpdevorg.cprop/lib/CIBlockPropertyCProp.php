...
class CIBlockPropertyCProp
{
    ...
    public function GetPropertyFieldHtml($arProperty, $value, $strHTMLControlName)
    {
        ...
        $result .= '<table class="mf-fields-list active" style="background:#F4E5C6">';
        ...
        foreach ($arFields as $code => $arItem){
            ...
            else if($arItem['TYPE'] === 'VisualEditor'){
                $result .= self::GetEditFormHTML($code, $arItem['TITLE'], $value, $strHTMLControlName);
            }
        }
...
*/
    ...
    private static function getOptionList($selected = 'string')
    {
        ...
        $arOption = [
            ...
            'VisualEditor' => 'HTML/Визуальный редактор'
        ];
